...
import com.mycompany.employeecommute.service.leave.annual.AnnualLeaveService;
...
public class AnnualLeaveController {
    ...
    public AnnualLeaveGetResponse getAnnualLeave(AnnualLeaveGetRequest request) {
